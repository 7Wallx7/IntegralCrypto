...
import com.integralCrypto.spring.login.payload.request.LoginRequest;
import com.integralCrypto.spring.login.payload.request.SignupRequest;
...
public class AuthController {
  ...
  public ResponseEntity<?> logoutUser() {
      ...
      String[] exposeHeaders = {"Content-Disposition", "X-Total-Count"};
